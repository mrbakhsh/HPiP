...
#' @param ppi A data.frame containing protein-protein interactions with edge score.
...
#' @param node.label.dist The distance of the label from the center of the node.
#' @return A PPI plot.
#' @author Matineh Rahmatbakhsh, \email{matinerb.94@gmail.com}
#' @importFrom igraph get.adjacency
#' @importFrom graphics par
#' @importFrom igraph graph_from_data_frame
#' @description Plot the predicted PPI. This function uses the plot function of the \code{igraph}.
#' @rdname plotPPI
#' @export
#' @examples
#' df <- data.frame(
