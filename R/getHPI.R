...
#' getHPI
#' @title Generating Host-Pathogen Protein-Protein Interaction (HP-PPI) Descriptors
...
#' @return A matrix containing the Host-Pathogen Protein-Protein Interaction (HP-PPI) descriptors.
#' @author Matineh Rahmatbakhsh \email{matinerb.94@gmail.com}
#' @description This function calculates Host-Pathogen Protein-Protein Interaction (HP-PPI) descriptors
#' via two approaches
#' \itemize{
