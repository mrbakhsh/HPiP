#' FreqInteractors
#' @title Plot the Pathogen Proteins' Frequency of Interactions with Host Proteins
...
#' @description This function plots the pathogen proteins' Frequency of interactions with host proteins
#' @export
#' @examples
#' ppi <- data.frame(
